  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 lg:px-6 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
        ...
        <div className="p-5 lg:p-6 flex flex-col gap-4 lg:gap-5 overflow-y-auto">
          {/* Visitor summary */}
          ...
          <div className="flex gap-2 lg:gap-3">
            <button onClick={onClose}
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-700 font-semibold text-sm">
              Cancel
            </button>
